...
const ProfilePage = () => {
    ...
    const { mutate, isLoading: updateProfileIsLoading } = useMutation({
      ...
      onSuccess: (data) => {
        ...
        toast.success("Profile as updated");
      },
      onError: (error) => {
    ...
    <MainLayout>
      <section className='container mx-auto px-5 py-10'>
        <div className='w-full max-w-sm mx-auto'>
          ...
          <form onSubmit={handleSubmit(submitHandler)} className='my-4'>
            ...
            className='bg-aqua text-white font-bold text-lg py-4 px-8 w-full rounded-lg mb-6 disabled:opacity-70 disabled:cursor-not-allowed'
            >
              Update
            </button>
          </form>
