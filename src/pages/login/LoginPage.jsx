      ...
      <section className="container mx-auto px-5 py-10">
        <div className="w-full max-w-sm mx-auto">
          ...
          <form onSubmit={handleSubmit(submitHandler)}>
            ...
            <Link to="/" className="text-sm font-semibold text-aqua">
              Forgot password?
            </Link>
            <button
              type="submit"
              disabled={!isValid || isLoading}
              className="bg-aqua text-white font-bold text-lg py-3 px-6 w-full rounded-lg my-6 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              Sign In
            </button>
            {/* <button
              type="submit"
              className="flex justify-center items-center bg-aqua text-white font-bold text-lg py-3 px-6 w-full rounded-lg mb-4 disabled:opacity-70 disabled:cursor-not-allowed"
            >
              Sign In With Google <FcGoogle size={26} className="ml-4" />
            </button> */}
            <p className="text-sm font-semibold text-[#5a7184]">
              Do not have an account?{" "}
              <Link to="/register" className="text-aqua">
                Register now
              </Link>
            </p>
          </form>
